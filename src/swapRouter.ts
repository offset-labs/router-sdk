...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from '@offsetcarbon/sdk-core'
import { abi } from '@offsetcarbon/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from '@offsetcarbon/v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
