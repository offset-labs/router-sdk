import { Ether, Token, WETH9, CurrencyAmount, Currency } from '@offsetcarbon/sdk-core'
...
describe('MixedRoute', () => {
  ...
  const token3 = new Token(421614, '0x0000000000000000000000000000000000000004', 18, 't3')
